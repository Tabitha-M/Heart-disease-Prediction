...
# Finction to create a downloaded link for a DataFrame as a csv file
...
with tab1:
    ...
    chest_pain = ["ATA", "NAP", "ASY", "TA"].index(chest_pain)
...
with tab2:
    ...
    st.subheader('Instruction tonote before uploading the file:')
    st.info("""
...
""")
    ...
    if uploaded_file is not None:
        ...
        # Ensure that the input DataFrame matches the expected columnsanf format
       ...
       'RestingECG', 'MaxHR', 'ExerciseAngina', 'Oldpeak', 'ST_Slope']
        ...
        if set(expected_columns).issubset(input_data.columns):
            ...
            #create a button todownload the updated CSV file
...
with tab3:
    ...
    data = {'Decision Trees':80.97, 'Logistic Regression': 85.66, 'Random Forest':84.23, 'Support Vector Machine':84.22}
